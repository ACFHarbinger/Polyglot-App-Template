...
- **Docstrings/doc-comments**: Google-style for Python, TSDoc for TypeScript, KDoc for Kotlin, `///` doc-comments for Rust, GoDoc conventions for Go, Doxygen for C++. Every public symbol gets one.
